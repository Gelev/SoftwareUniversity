function startApp() {
    ...
    function listAds() {
        ...
        .append(`<tr>
            ...
            for(let product of products){
                let links = [];
                let readMoreButton = $('<a href = "#">[READ MORE]</a>').click(function (){displayAdditionalInfo(product._id);});
                links.push(readMoreButton);
                links.push(" ");
    ...
    function displayAdditionalInfo(entryId) {
        $('#viewDetailsAd').empty();
        ...
        $.ajax({
            ...
            headers: {'Authorization': "Kinvey " + sessionStorage.getItem('authToken')},
            success: getAdditionalProductDataSuccess,
            error: handleAjaxError
        });
        function getAdditionalProductDataSuccess(entry){
            console.log(entry);
            adBody
                .append($('<img>').attr('src', entry.image))
                .append('<br>')
                .append('Title:')
                .append('<br>')
    ...
    function editEntry(entryId){
        ...
        function getProductDataSuccess(productData){
            ...
            $('#formEditAd input[name=image]').val(productData.image);
        }
    }
